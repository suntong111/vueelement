...
<!--                </el-col>-->
<!--            </el-row>-->
            <pagination v-show="paginations.total>0" :total="paginations.total" :page.sync="paginations.listQuery.page" :limit.sync="paginations.listQuery.limit" @pagination="getList" />
        </div>
        <!-- 弹框页面 -->
...
export default {
  ...
  methods: {
    ...
    getProfile() {
  //     // 获取表格数据
      this.$axios.post("/api/cash").then(res => {
